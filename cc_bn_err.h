...
typedef enum
{
    ...
    CC_BN_ERR_A_LT_B = 0x101,        // ERROR: args A<B
    CC_BN_ERR_DIV_BY_ZERO = 0x102,   // ERROR: division by zero
    CC_BN_ERR_NOT_SQUARE = 0x103,    // ERROR: not a square
    CC_BN_ERR_GEN_RAND = 0x104,      // ERROR: random number generation failed
} cc_bn_status_t;
