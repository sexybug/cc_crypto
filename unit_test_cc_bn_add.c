...
void test_basic_addition_no_carry() {
    ...
    cc_bn_t carry = cc_bn_add(A, 3, B, 2, X);
...
void test_equal_length() {
    ...
    cc_bn_t carry = cc_bn_add(A, 3, B, 3, X);
...
void test_empty_B() {
    ...
    cc_bn_t carry = cc_bn_add(A, 3, NULL, 0, X);
...
void test_single_digit() {
    ...
    cc_bn_t carry = cc_bn_add(A, 1, B, 1, X);
...
void test_maximum_values() {
    ...
    cc_bn_t carry = cc_bn_add(A, 2, B, 2, X);
...
void test_large_arrays() {
    ...
    cc_bn_t carry = cc_bn_add(A, 10, B, 5, X);
