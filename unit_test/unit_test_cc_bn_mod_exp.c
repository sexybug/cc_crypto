...
int main(void)
{
    ...
    {
        cc_bn_t A[3] = {0x77777777, 0x77777777, 0x77777777};
        cc_bn_t E[3] = {0x55555555, 0x55555555, 0x55555555};
        cc_bn_t N[2] = {0x87654321, 0x87654321};
        size_t N_len = 2;
        cc_bn_t R2[2];
...

    {
        ...
        cc_bn_t E[2] = {0xFFFFFFFF, 0xFFFFFFF2};
...

    {
        ...
        cc_bn_t E[3] = {0xFFFFFFFF, 0xFFFFFFFF, 0};
