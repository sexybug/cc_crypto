...
// 辅助函数：比较两个数组是否相等
int arrays_equal(const cc_bn_word_t *arr1, const cc_bn_word_t *arr2, size_t len)
{
...
void test_cc_bn_sub_small()
{
    ...
    // A = [2, 3], B = [5, 1], 期望结果: X = [ULONG_MAX - 2, 1], borrow = 0
    {
        cc_bn_word_t A[] = {2, 3};
        cc_bn_word_t B[] = {5, 1};
        cc_bn_word_t expected[] = {(cc_bn_word_t)(-3), 1};
        memset(result, 0, sizeof(result));
    ...
    {
        cc_bn_word_t A[] = {10, 5, 3};
        cc_bn_word_t B[] = {3, 2};
        cc_bn_word_t expected[] = {7, 3, 3};
        memset(result, 0, sizeof(result));
    ...
    {
        cc_bn_word_t A[] = {0, 0, 1};
        cc_bn_word_t B[] = {1};
        cc_bn_word_t expected[] = {(cc_bn_word_t)(-1), (cc_bn_word_t)(-1), 0};
        memset(result, 0, sizeof(result));
    ...
    // A = [3], B = [10], 期望结果: X = [ULONG_MAX - 6], borrow = 1
    {
        cc_bn_word_t A[] = {3};
        cc_bn_word_t B[] = {10};
        cc_bn_word_t expected[] = {(cc_bn_word_t)(-7)};
        memset(result, 0, sizeof(result));
    ...
    {
        cc_bn_word_t A[] = {(cc_bn_word_t)(-1)};
        cc_bn_word_t B[] = {1};
        cc_bn_word_t expected[] = {(cc_bn_word_t)(-2)};
        memset(result, 0, sizeof(result));
    ...
    {
        cc_bn_word_t A[] = {0, 0, 0, 1};
        cc_bn_word_t B[] = {1, 0, 0};
        cc_bn_word_t expected[] = {(cc_bn_word_t)(-1), (cc_bn_word_t)(-1), (cc_bn_word_t)(-1), 0};
        memset(result, 0, sizeof(result));
