...
// 测试辅助函数：初始化大数
void init_bn(cc_bn_t *bn, size_t len, cc_bn_t value) {
    memset(bn, 0, len * sizeof(cc_bn_t));
    if (len > 0) {
        bn[0] = value;
    }
}
