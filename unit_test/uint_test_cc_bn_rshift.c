...
// 辅助函数：比较两个大数数组是否相等
int cc_bn_compare(const cc_bn_t *a, const cc_bn_t *b, size_t len)
{
    return memcmp(a, b, len * sizeof(cc_bn_t));
}
...
void test_cc_bn_rshift()
{
    ...
    {
        printf("测试用例3: 按字边界移位\n");
        cc_bn_t input[] = {0x12345678, 0x9ABCDEF0, 0xFEDCBA98, 0x11223344};
        cc_bn_t output[4];
    ...
    { // 9ABCDEF012345678
        ...
        cc_bn_t expected1[] = {0x01234567, 0x09ABCDEF};
