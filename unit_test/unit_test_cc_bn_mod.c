...
void test_cc_bn_div()
{
    ...
    // 测试用例1：除数为零
    {
        ...
        int result = cc_bn_div(A, 4, N, 4, Q, R);
    ...
    // 测试用例2：被除数长度小于除数长度
    {
        ...
        int result = cc_bn_div(A, 2, N, 4, Q, R);
    ...
    // 测试用例9：多字长度测试
    {
        ...
        int result = cc_bn_div(A, 8, N, 4, Q, R);
        assert(result == CC_BN_SUCCESS);
        assert(bn_equals(Q, expected_Q, sizeof(expected_Q) / sizeof(expected_Q[0])));
        assert(bn_equals(R, expected_R, sizeof(expected_R) / sizeof(expected_R[0])));
        printf("测试9通过：多字长度除法\n");
    ...
    // 测试用例11：大数除法测试
    {
        ...
        int result = cc_bn_div(A, 2, N, 1, Q, R);
        assert(result == CC_BN_SUCCESS);
        assert(bn_equals(Q, expected_Q, sizeof(expected_Q) / sizeof(expected_Q[0])));
        assert(bn_equals(R, expected_R, sizeof(expected_R) / sizeof(expected_R[0])));
        printf("测试11通过：大数除法\n");
    ...
    // 测试用例12：大数除法测试
    {
        ...
        int result = cc_bn_div(A, 2, N, 2, Q, R);
        assert(result == CC_BN_SUCCESS);
        assert(bn_equals(Q, expected_Q, sizeof(expected_Q) / sizeof(expected_Q[0])));
        assert(bn_equals(R, expected_R, sizeof(expected_R) / sizeof(expected_R[0])));
        printf("测试12通过：大数除法\n");
