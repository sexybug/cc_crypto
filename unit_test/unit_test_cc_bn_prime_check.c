...
int main(void)
{
    ...
    {
        cc_bn_word_t N[2] = {0x7C16BAD7, 0xCDD1ADCB};
        size_t N_len = sizeof(N) / sizeof(N[0]);
    ...
    {
        cc_bn_word_t N[CC_BN_MAX_WORDS] = {0};
        size_t bits = 2048;
