...
void test_cc_bn_mod_word() {
    ...
    // 测试用例1：除数为1的情况
    {
        cc_bn_t A[] = {123, 456, 789};
        cc_bn_t result = cc_bn_mod_word(A, 3, 1);
        assert(result == 0);
    ...
    {
        cc_bn_t A[] = {0, 0, 0};
        cc_bn_t result = cc_bn_mod_word(A, 3, 5);
        assert(result == 0);
    ...
    {
        cc_bn_t A[] = {123};  // 奇数
        cc_bn_t result = cc_bn_mod_word(A, 1, 2);
        assert(result == 1);
    ...
    {
        cc_bn_t A[] = {100};
        cc_bn_t result = cc_bn_mod_word(A, 1, 7);
    ...
    // 测试用例6：多个字长度的除法
    {
        cc_bn_t A[] = {0x1, 0x1};  // 表示 2^32 + 1
        cc_bn_t result = cc_bn_mod_word(A, 2, 3);
        assert(result == 2);
    ...
    {
        cc_bn_t A[] = {0xFFFFFFFF};  // 2^32 - 1
        cc_bn_t result = cc_bn_mod_word(A, 1, 10);
    ...
    {
        cc_bn_t A[] = {5, 0, 0};
        cc_bn_t result = cc_bn_mod_word(A, 3, 10);
        assert(result == 5);
    ...
    {
        cc_bn_t A[] = {42};
        cc_bn_t result = cc_bn_mod_word(A, 1, 13);
    ...
    {
        cc_bn_t A[] = {15};
        cc_bn_t result = cc_bn_mod_word(A, 1, 15);
        assert(result == 0);
    ...
    // 测试用例11：大的除数
    {
        cc_bn_t A[] = {0x100, 0x200};
        cc_bn_t result = cc_bn_mod_word(A, 2, 0x80000000);  // 2^31
        assert(result == 0x100);
    ...
    // 测试用例13：最大32位数的多字测试
    {
        cc_bn_t A[] = {0xFFFFFFFF, 0xFFFFFFFF};  // 2^64 - 1 在32位表示
        cc_bn_t result = cc_bn_mod_word(A, 2, 7);
        // 需要根据实际算法计算期望值
        assert(result == 1);
    ...
    // 测试用例15：典型的三字长度测试
    {
        ...
        cc_bn_t result = cc_bn_mod_word(A, 3, 1000000);
