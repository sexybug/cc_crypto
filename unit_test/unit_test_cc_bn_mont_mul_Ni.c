...
int main(void)
{
    ...
    {
        cc_bn_word_t N[8] = {0x00000001, 0x00000000, 0x00000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF};
        size_t N_len = 8;
        cc_bn_word_t Ni[2];
        cc_bn_word_t expected[2] = {0xffffffff, 0xffffffff};

        cc_bn_mont_Ni_R(Ni, N, 64);

        assert(memcmp(Ni, expected, sizeof(expected)) == 0);
    }
